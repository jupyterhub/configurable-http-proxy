...
ConfigurableProxy.prototype.remove_route = function (path, cb) {
    ...
    routes.get(path, function (result) {
        if (result) {
...
ConfigurableProxy.prototype.get_route = function (req, res, path) {
    // GET a single route
    path = this._routes.cleanPath(path);
    this._routes.get(path, function (route) {
        if (!route) {
            res.writeHead(404);
            res.end()
            return;
...
ConfigurableProxy.prototype.get_routes = function (req, res, path) {
...
ConfigurableProxy.prototype.delete_routes = function (req, res, path) {
    ...
    var that = this;
    this._routes.get(path, function (result) {
        if (result) {
...
ConfigurableProxy.prototype.update_last_activity = function (prefix, cb) {
    ...
    routes.get(prefix, function (result) {
        cb = cb || function() {};
